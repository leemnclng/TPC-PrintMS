...
class PrintJob(Base):
    ...
    brightness: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    contrast: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    saturation: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    warmth: Mapped[int] = mapped_column(Integer, default=0, nullable=False)

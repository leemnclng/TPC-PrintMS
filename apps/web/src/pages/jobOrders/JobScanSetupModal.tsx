...
export function JobScanSetupModal({ open, order, item, onClose, onScanned }: Props) {
  ...
  async function acquirePage() {
    ...
    setError(null);
    try {
      setScanFeedback({ tone: "progress", title: "Scanning in progress", detail: `Starting ${scanSourceLabel(scanSettings.source)} in color at ${scanSettings.resolutionDpi} DPI. Keep the original in place.` });

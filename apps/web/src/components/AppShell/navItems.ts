...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Templates", path: "/templates", matchPrefix: "/templates", icon: "templates" },
      { label: "Tools", path: "/tools", matchPrefix: "/tools", icon: "tools" },
  ...
  },
  {
    label: "Insights",
    items: [
      { label: "Reports", path: "/reports", matchPrefix: "/reports", icon: "reports" },
      { label: "Pricing", path: "/pricing", matchPrefix: "/pricing", icon: "configuration" },
    ],
  },
  {
    items: [

...
export function ExpensesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      <path d="M3.2 5.4h13.6v11H3.2zM5.2 3.4h9.6v2" />
      <path d="M6.4 9h7.2M6.4 12.2h4.2" />
      <circle cx="14.1" cy="12.5" r="1.7" />
    </svg>
  );
}
...
export function TemplatesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      <rect x="2.8" y="3.2" width="14.4" height="13.6" rx="1.2" />
      <rect x="5.2" y="6.1" width="6.2" height="4" rx=".5" />
      <path d="M13.6 6.1h1.2M13.6 8.1h1.2M5.2 13.7h9.6" />
    </svg>
  );
}

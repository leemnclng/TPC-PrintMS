...
contextBridge.exposeInMainWorld("paperClub", {
  ...
  openPricingOverview: () => ipcRenderer.invoke("paper-club:open-pricing-overview"),
  switchEnvironment: (stage: string) => ipcRenderer.invoke("paper-club:switch-environment", stage),
  getStorageLocation: () => ipcRenderer.invoke("paper-club:get-storage-location"),
  chooseStorageLocation: () => ipcRenderer.invoke("paper-club:choose-storage-location"),
  moveStorageLocation: (destination: string) => ipcRenderer.invoke("paper-club:move-storage-location", destination),
  getPrintSourceFolder: () => ipcRenderer.invoke("paper-club:get-print-source-folder"),
  choosePrintSourceFolder: () => ipcRenderer.invoke("paper-club:choose-print-source-folder"),
  clearPrintSourceFolder: () => ipcRenderer.invoke("paper-club:clear-print-source-folder"),
  matchPrintSource: (documentName: string) => ipcRenderer.invoke("paper-club:match-print-source", documentName),
